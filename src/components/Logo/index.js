...
export default class Logo extends Component {
  ...
  render () {
    return (
      <div className={style.Logo} onMouseEnter={this.mouseOver} onMouseLeave={this.mouseOut} >
        <svg
          id={'logo-rogmx'}
          ...
          <g>
            <path className={
                this.state.flipInvader ? style['Logo__Invader--flip'] : style['Logo__Invader']
              }
          ...
          <g id={'letter-r'} className={classNames({
            [style.Logo__Letter]: true,
            [style['Logo__Letter--animated']]: this.state.animated
          })} fill={'#0091FF'} stroke={'#000'} stroke-width={'1px'} stroke-opacity={'.1'}>
